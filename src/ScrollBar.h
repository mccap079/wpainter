...
public:
	...
	*/
		...
		gap = 10;               // Distance between images, and between images and scroll bar
	...
	void update() {
		...
		if (contentHeight > panelHeight) {
			...
			// this ratio tell us how much the grip is down. If 0, the grip is at the top of the scroll bar.
